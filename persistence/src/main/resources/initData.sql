...
values (1, 'Administrator',
        ARRAY [ 'USER_READ' ,'USER_CREATE' ,'USER_UPDATE' ,'USER_DELETE' ,'CLUB_READ' ,'CLUB_CREATE' ,'CLUB_UPDATE' ,'CLUB_DELETE', 'AFFILIATION_VALIDATE' ,'PERSON_READ' ,'PERSON_CREATE' ,'PERSON_UPDATE' ,'PERSON_DELETE' ,'SEASON_READ' ,'SEASON_CREATE' ,'SEASON_UPDATE' ,'SEASON_DELETE', 'AFFILIATION_READ', 'AFFILIATION_CREATE', 'AFFILIATION_UPDATE', 'AFFILIATION_DELETE', 'AFFILIATION_VALIDATE', 'AFFILIATION_REJECT']);
INSERT INTO sikb.profileType (id, name, functionalities)
values (2, 'Club',
        ARRAY [ 'CLUB_READ' , 'CLUB_UPDATE' ,'PERSON_READ' ,'PERSON_CREATE' ,'PERSON_UPDATE' ,'PERSON_DELETE','SEASON_READ','AFFILIATION_READ', 'AFFILIATION_CREATE', 'AFFILIATION_UPDATE', 'AFFILIATION_DELETE']);
INSERT INTO sikb.profileType (id, name, functionalities)
values (3, 'Ligue',
        ARRAY [ 'CLUB_READ' ,'CLUB_CREATE' ,'CLUB_UPDATE','PERSON_READ' ,'PERSON_CREATE' ,'PERSON_UPDATE' ,'PERSON_DELETE','SEASON_READ']);
INSERT INTO sikb.profileType (id, name, functionalities)
values (4, 'FKBF',
        ARRAY [ 'USER_READ' ,'USER_CREATE' ,'USER_UPDATE' ,'USER_DELETE' ,'CLUB_READ' ,'CLUB_CREATE' ,'CLUB_UPDATE' ,'CLUB_DELETE' ,'AFFILIATION_VALIDATE','PERSON_READ' ,'PERSON_CREATE' ,'PERSON_UPDATE' ,'PERSON_DELETE' ,'SEASON_READ' ,'SEASON_CREATE' ,'SEASON_UPDATE' ,'SEASON_DELETE', 'AFFILIATION_READ', 'AFFILIATION_CREATE', 'AFFILIATION_UPDATE', 'AFFILIATION_DELETE', 'AFFILIATION_VALIDATE', 'AFFILIATION_REJECT']);
